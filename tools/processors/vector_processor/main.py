...
if __name__ == '__main__':
    ...
    # Path
    argparser.add_argument('--output_vector_path', type=str, default="../../../data/output/hg2vec.txt",
                           help="The path of output vector file for evaluate")
    argparser.add_argument('--output_ckpt_path', type=str, default="../../../data/output/ckpt/hg2vec.ckpt",
                           help="The path of output ckpt for further use")
    argparser.add_argument('--input_vector_folder', type=str, default="../../../data/input/path/",
                           help="The path of input path folder")
    argparser.add_argument('--input_id_info', type=str, default="../../../data/input/id_info.csv",
                           help="The path of input word2id folder")
    argparser.add_argument('--strong_file', type=str, default="../../../data/input/strong-pairs.pkl",
                           help="The path of input strong pairs")
    argparser.add_argument('--weak_file', type=str, default="../../../data/input/weak-pairs.pkl",
                           help="The path of input weak pairs")
    argparser.add_argument('--syn_file', type=str, default="../../../data/input/syn-pairs.pkl",
                           help="The path of input synonym pairs")
    argparser.add_argument('--ant_file', type=str, default="../../../data/input/ant-pairs.pkl",
    ...
    argparser.add_argument('--lang', type=str, default="en", choices=["en", "fr"],
                           help="Language to train and evaluate (en or fr)")                    
    # Size
